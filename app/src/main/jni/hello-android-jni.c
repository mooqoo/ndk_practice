...
Java_com_example_wangalbert_prac_12_MainActivity_getMsgFromJni(JNIEnv *env, jobject instance) {
...
Java_com_example_wangalbert_prac_12_MainActivity_naMain(JNIEnv *pEnv, jobject pObj, jobject pMainAct, jstring pFileName, jint pNumOfFrames) {
